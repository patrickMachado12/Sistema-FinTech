...
namespace FinTech.Test.TesteUnitario.Services
{
    public class APagarServiceTests
    {
        ...
        public async Task Adicionar_DeveRetornarAPagarResponseContract_QuandoAPagarEhValido()
        {
            ...
            var aPagar = new APagar { Id = 1, IdNaturezaLancamento = 1, ValorAPagar = 100.00 };
        ...
        public async Task Atualizar_DeveRetornarAPagarResponseContract_QuandoAPagarEhValido()
        {
            var id = 1;
            var aPagarRequestContract = new APagarRequestContract { IdNaturezaLancamento = 1, ValorAPagar = 100.00 };
            var aPagar = new APagar { Id = id, IdNaturezaLancamento = 1, ValorAPagar = 100.00 };
            var aPagarResponseContract = new APagarResponseContract { Id = 1, IdNaturezaLancamento = 1, ValorAPagar = 100.00 };
        ...
        public async Task ObterTodos_DeveRetornarListaDeAPagarResponseContract_QuandoAPagarExistem()
        {
            ...
            {
                new APagar { Id = 1, IdNaturezaLancamento = 1, ValorAPagar = 100.00 },
                new APagar { Id = 2, IdNaturezaLancamento = 2, ValorAPagar = 200.00 }
            };
